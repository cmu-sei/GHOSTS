...
//                     //watch a folder
//                     case "folder":
//                         var fw = new FolderWatcher(this.Handler, timelineEvent, timelineEvent.Command);
//                         folderWatcherList.Add(fw);
//                         break;
//                     //File
//                     default:
//                         var w = new FileWatcher(this.Handler, timelineEvent, timelineEvent.Command);
...
// }
//
// internal class FolderWatcher(Timeline entireTimeline, TimelineHandler timelineHandler, CancellationToken cancellationToken)
//     : BaseHandler(entireTimeline, timelineHandler, cancellationToken)
// {
...
//         //                 else if (words[0] == "size" && long.TryParse(words[1], out var localsize))
//         //                     folderMaxSize = localsize * 1024 * 1024;
...
//         //     {
//         //         _log.Trace("In Watcher handler, 'path' argument " + folderPath +
//         //                    " is not a valid folder, Watcher exiting.");
//         //         return;
//         //     }
//         //
//         //     if (folderMaxSize == -1)
...
//         //     {
//         //         _log.Trace(
//         //             "In Watcher handler, 'deletionApproach' argument {deletionApproach} is unrecognized using random.");
...
//         //     {
//         //         NotifyFilter = NotifyFilters.Size, EnableRaisingEvents = true, IncludeSubdirectories = true
//         //     };
