...
const endpoints = makeApi([
	...
	{
		method: "get",
		path: "/timelines/:machineId/:timeLineId",
	...
	{
		method: "post",
		path: "/timelines/:machineId/:timeLineId/stop",
...
export const CLIENT_GHOSTS_API_PATH = "/ghosts-api";
