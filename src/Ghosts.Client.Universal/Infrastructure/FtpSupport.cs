...
public class FtpSupport : SshSftpSupport
{
    ...
    //             response.Close();
    //             Log.Trace(
    //                 $"Ftp:: Success, Downloaded remote file {remoteFilePath},host {hostip}  to file {localFilePath},  ");
    //         }
    //     }
    //     catch (ThreadAbortException)
    //     {
    ...
    //
    //                 Log.Trace(
    //                     $"Ftp:: Success, Uploaded local file {fileName} to file {remoteFileName}, host {hostip}");
    //             }
    //         }
    //
    //         response.Close();
