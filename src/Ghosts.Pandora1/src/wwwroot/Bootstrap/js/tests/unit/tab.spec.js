  ...
  describe('data-api', () => {
    ...
    it('should handle nested tabs', done => {
      fixtureEl.innerHTML = [
        ...
        '</nav>',
        '<div class="tab-content">',
        '  <div class="tab-pane fade" id="x-tab1" role="tabpanel">',
        '    <nav class="nav nav-tabs" role="tablist">',
        ...
        '    </nav>',
        '    <div class="tab-content">',
        '      <div class="tab-pane fade active show" id="nested-tab1" role="tabpanel">Nested Tab1 Content</div>',
        '      <div class="tab-pane fade" id="nested-tab2" role="tabpanel">Nested Tab2 Content</div>',
        '    </div>',
        '  </div>',
        '  <div class="tab-pane fade active show" id="x-tab2" role="tabpanel">Tab2 Content</div>',
        '  <div class="tab-pane fade" id="x-tab3" role="tabpanel">Tab3 Content</div>',
        '</div>'
      ].join('')
